FROM ghcr.io/nmfs-opensci/py-rocket-geospatial-2:2026.02.18
...
LABEL org.opencontainers.image.version=2026.04.17
...
# Update conda env
RUN set -eux; \
    /pyrocket_scripts/install-conda-packages.sh /tmp/environment.yml
